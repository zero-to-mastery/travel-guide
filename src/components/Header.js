...
const header = () => {
  return (
    <header className="white-80 tc pv4 header pb7 ">
      ...
      <div data-aos="fade-up" data-aos-duration="7000"><Link to="/travel-guide"><div data-aos="fade-up" data-aos-duration="7000"><Link to="/travel-guide"><iframe src="https://giphy.com/embed/yo1whaKkz38ME" width="150" height="100" frameBorder="0" className="giphy-embed" allowFullScreen></iframe></Link></div></Link></div>
