...
const Detail = () => {
  ...
  useEffect(() => {
    axios.get(`https://restcountries.com/v3.1/name/${id}?fields=name,flags,region,latlng,capital,population,currencies,languages,borders,cca3,timezones,demonyms,idd`)
      .then((response) => {
        ...
        if (id === "Timor-Leste") {
          data = { ...data, currencies: { USD: { name: "United States dollar", symbol: "$" } } };
        }
    ...
    <div className="centerflex">
      <div className="tc bg-white-90 detailCard code dib br3 pb1 mt3 mb3 bw2 shadow-5 region">
        <div className="region-details">
          <img alt={details.region} src={details.flags.svg} height="100" width="200" />
